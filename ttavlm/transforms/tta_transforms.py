# Simple Post-Training Robustness Using Test Time Augmentations
...
class ColorJitterPro(ColorJitter):
    ...
    def __init__(self, brightness= 0, contrast = 0, saturation = 0, hue = 0, gamma = 0) -> None:
...
def get_tta_transforms(n_pixels, gaussian_std: float=0.005, soft=False, padding_mode='edge', cotta_augs=True):

    tta_transforms = [
        ClipTransform(0.0, 1.0),
        ColorJitterPro(
...
def get_simple_tta_transforms(n_pixels):
